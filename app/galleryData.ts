...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: `${p}/rejoov-before-v2.jpg`, alt: 'Aged asphalt shingle roof with sun-baked fading before Roof Rejoov bio-oil treatment — Katy, Texas', category: 'roof-rejoov', tags: [], caption: 'Before Roof Rejoov' },
  { src: `${p}/rejoov-after-v2.jpg`, alt: 'Same roof after Roof Rejoov bio-oil treatment — restored color, flexibility and waterproofing in Katy, Texas', category: 'roof-rejoov', tags: [], caption: 'After Roof Rejoov' },
