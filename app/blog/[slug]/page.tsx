          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: post.title,
                item: `https://hernandeztreeservice.com/blog/${post.slug}`,
              },
            ],
          }),
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            publisher: {
              ...
              logo: {
                '@type': 'ImageObject',
                url: 'https://hernandeztreeservice.com/tree_pro/tree_logo.svg',
              },
            },
            mainEntityOfPage: {
              '@type': 'WebPage',
              '@id': `https://hernandeztreeservice.com/blog/${post.slug}`,
            },
