...
export function ComparisonSlider(props: ComparisonSliderProps) {
 ...
 <div className="relative aspect-[5/4] overflow-hidden border border-slate-200 bg-white">
 ...
 <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 border border-white/60 bg-white p-1 shadow-sm">
 <div className="h-2.5 w-2.5 " style={{ backgroundColor: accent }} />
 </div>
 </div>
 </div>
 <input
 ...
 className="mt-4 h-2 w-full cursor-ew-resize appearance-none "
 style={{
 ...
 <div className="absolute left-4 top-4 border border-slate-200 bg-white/95 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-700">
 Before
 </div>
 <div className="absolute right-4 top-4 border border-slate-200 bg-white/95 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-700">
 After
 </div>
 ...
 className=" border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-700"
 style={{ color: accent }}
 >
 Upload Before
 </button>
 ...
 className="mt-4 h-2 w-full cursor-ew-resize appearance-none bg-slate-200"
 style={{
