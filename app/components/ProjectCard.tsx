...
export function ProjectCard({
 ...
 return (
 <div className="snap-center shrink-0 w-[85vw] md:w-auto flex flex-col group relative overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 bg-white">
 {/* Image Container */}
 ...
 className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold uppercase tracking-wider shadow-lg transition-transform hover:scale-105 active:scale-95"
 style={{
 ...
 <span
 className="px-2 py-1 text-[10px] font-black uppercase tracking-widest text-white shadow-sm transition-colors duration-300"
 ...
 {/* Minimal indicator */}
 <div className="mt-4 h-1 w-8 " style={{ backgroundColor: actionColor, opacity: 0.3 }} />
 </div>
 </div>
 );
}
